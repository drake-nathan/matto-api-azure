export const oneHundredxAbi = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "_method", type: "uint256" }],
    name: "SHUFFLE",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "bool", name: "_cropped", type: "bool" },
      { internalType: "bool", name: "_blackBackground", type: "bool" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_tokenId", type: "uint256" },
      { internalType: "string", name: "_layerContent", type: "string" },
    ],
    name: "overrideLayer",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "string", name: "_artistName", type: "string" }],
    name: "setArtistName",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_baseShuffleFee", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "string[]", name: "_blackBackground", type: "string[]" },
    ],
  ...
  {
    inputs: [{ internalType: "string", name: "_externalUrl", type: "string" }],
    name: "setExternalUrl",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address", name: "_svgContract", type: "address" },
      { internalType: "address", name: "_shuffleContract", type: "address" },
    ],
    name: "setInterfaces",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256[]", name: "_newOrder", type: "uint256[]" },
    ],
    name: "setOrder",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "string", name: "_SVGfilter", type: "string" }],
    name: "setSVGfilter",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "string", name: "_website", type: "string" }],
    name: "setWebsite",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
